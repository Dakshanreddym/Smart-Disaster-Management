...
public class Admin {
    ...
    public Admin(long id, String name, String email, String username, String password, LocalDateTime createdAt, LocalDateTime updatedAt, boolean enabled, String role) {
        this.id = id;
        this.name = name;
        this.email = email;
